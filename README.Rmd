...
knitr::kable(
  tibble::tibble(
    script = CursoRopen:::list_github_files(params$main_repo, pasta, ".R$", pat = TRUE),
    link = paste0(
...
tibble::tibble(
  ...
  dplyr::filter(stringr::str_detect(
    exercicio,
    paste(sprintf("%02d", seq_len(as.numeric(params$num_aula))), collapse = "|")
  )) %>%
